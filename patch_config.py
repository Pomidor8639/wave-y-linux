...
overrides = {
    ...
    'CONFIG_LOGO_LINUX_MONO': 'CONFIG_LOGO_LINUX_MONO=y\n',
    'CONFIG_LOGO_LINUX_VGA16': 'CONFIG_LOGO_LINUX_VGA16=y\n',
    'CONFIG_LOGO_LINUX_CLUT224': 'CONFIG_LOGO_LINUX_CLUT224=y\n',
    'CONFIG_VGA_CONSOLE': '# CONFIG_VGA_CONSOLE is not set\n',
    'CONFIG_DUMMY_CONSOLE': 'CONFIG_DUMMY_CONSOLE=y\n',
    'CONFIG_BCM_LCD_SKIP_INIT': 'CONFIG_BCM_LCD_SKIP_INIT=y\n',
}
